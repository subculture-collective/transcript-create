...
def admin_events(request: Request, db=Depends(get_db), type: str | None = None, user_email: str | None = None, start: str | None = None, end: str | None = None, limit: int = 100, offset: int = 0):
...
def admin_events_csv(request: Request, db=Depends(get_db), type: str | None = None, user_email: str | None = None, start: str | None = None, end: str | None = None, limit: int = 1000, offset: int = 0):
    user = _get_user_from_session(db, _get_session_token(request))
    if not _is_admin(user):
        raise HTTPException(403)
    where = []
