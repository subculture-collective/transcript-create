      ...
      <header className="border-b">
        <div className="mx-auto flex max-w-7xl items-center justify-between p-4">
          ...
          <nav className="flex items-center gap-4">
            ...
            <Link to="/favorites" className="text-stone-600 hover:text-stone-900">
              Favorites
            </Link>
            ...
            {loading ? (
              ...
              <div className="flex items-center gap-3">
                ...
                {user.plan === 'pro' && (
                  <>
                    ...
                    <a href="/api/billing/portal" className="text-stone-600 hover:text-stone-900">
                      Manage billing
                    </a>
                  </>
                )}
              ...
              <div className="flex items-center gap-3">
                <button onClick={login} className="text-stone-600 hover:text-stone-900">
                  Login with Google
                </button>
                <span className="text-stone-400">|</span>
                <button onClick={loginTwitch} className="text-stone-600 hover:text-stone-900">
                  Login with Twitch
                </button>
              </div>
            )}
